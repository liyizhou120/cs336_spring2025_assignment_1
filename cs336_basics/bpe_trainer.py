...
if __name__ == "__main__":
    ...
    trainer.to_files("/media/yizhouli/1TB 970 Evo Plus/code/cs336/data/output/TinyStories_train_10000_token_vocab.bin", "/media/yizhouli/1TB 970 Evo Plus/code/cs336/data/output/TinyStories_train_10000_merges.bin")